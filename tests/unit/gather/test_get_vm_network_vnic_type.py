...
from gather import get_vm_network_vnic_type

class TestVMNetworkVnicType(unittest.TestCase):

    # =========================
    # execute_cmd
    # =========================
    @patch("gather.get_vm_network_vnic_type.subprocess.run")
...
"""
    ...
    # =========================
    # get_vm_network_vnic_type
    # =========================
    @patch("gather.get_vm_network_vnic_type.get_vm_nic_list")
    def test_get_vm_network_vnic_type_success(self, mock_nics):
