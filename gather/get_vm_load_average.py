...
class VMCollector:
    ...
    def collect_single_vm_data(self, vm_name: str) -> Dict:
        ...
        load_average = self.call_qga_interface(vm_name, "guest-get-load-average")
        vm_data = {
            "name": vm_name,
            "get_load_average": {
                "interface": "guest-get-load-average",
                "error": load_average["error"],
                "data": load_average["data"]
            },
        }
    ...
    def save_data(self):
        ...
        file_name = f"get_load_average_{timestamp}.json"
