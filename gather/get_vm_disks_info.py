...
class VMCollector:
    def __init__(self, output_dir: str = "./get_vm_disks_info_data"):
    ...
    def collect_single_vm_cpustinfo_data(self, vm_name: str) -> Dict:
        ...
        tcp_conn_state = self.call_qga_interface(vm_name, "guest-get-disks")
        vm_data = {
            "name": vm_name,
            "get_disks_info": {
                "interface": "guest-get-disks",
    ...
    def save_data(self):
        ...
        file_name = f"get_disks_info_{timestamp}.json"
