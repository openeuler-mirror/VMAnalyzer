...
class VMCollector:
    def __init__(self, output_dir: str = "./get_vm_oom_status_data"):
        ...
        try:
            ...
            raise  # English comment for this block.
    ...
    def collect_single_vm_data(self, vm_name: str) -> Dict:
        ...
        oom_status = self.call_qga_interface(vm_name, "guest-get-oom-status")
        vm_data = {
            "name": vm_name,
            "get_oom_status": {
                "interface": "guest-get-oom-status",
                "error": oom_status["error"],
                "data": oom_status["data"]
            },
        }
    ...
    def save_data(self):
        ...
        file_name = f"get_oom_status_{timestamp}.json"
