...
class VMCollector:
    def __init__(self, output_dir: str = "./get_vm_memory_status_data"):
    ...
    def collect_single_vm_data(self, vm_name: str) -> Dict:
        ...
        tcp_conn_state = self.call_qga_interface(vm_name, "guest-get-memory-status")
        vm_data = {
            "name": vm_name,
            "get_memory_ststus": {
    ...
    def save_data(self):
        ...
        file_name = f"get_memory_status_{timestamp}.json"
