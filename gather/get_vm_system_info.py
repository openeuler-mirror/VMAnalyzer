...
class VMCollector:
    def __init__(self, output_dir: str = "./get_vm_system_info_data"):
    ...
    def collect_single_vm_data(self, vm_name: str) -> Dict:
        ...
        tcp_conn_state = self.call_qga_interface(vm_name, "guest-get-system-info")
        vm_data = {
            "name": vm_name,
            "get_system_info": {
                "interface": "guest-get-system-info",
    ...
    def save_data(self):
        ...
        file_name = f"get_system_info_{timestamp}.json"
