...
class VMCollector:
    def __init__(self, output_dir: str = "./get_lastboot_time_data"):
    ...
    def collect_single_vm_data(self, vm_name: str) -> Dict:
        ...
        lastboot_time = self.call_qga_interface(vm_name, "guest-get-lastboot-time")
        vm_data = {
            "name": vm_name,
            "get_lastboot_time": {
                "interface": "guest-get-lastboot-time",
                "error": lastboot_time["error"],
                "data": lastboot_time["data"]
            },
        }
