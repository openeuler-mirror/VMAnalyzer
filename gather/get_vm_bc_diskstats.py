...
class VMCollector:
    def __init__(self, output_dir: str = "./get_bc_diskstats_data"):
    ...
    def get_vm_state(self, vm_name: str) -> str:
        """Documentation for this component."""
        cmd = f"virsh domstate {shlex.quote(vm_name)}"  # English comment for this block.
    ...
    def save_data(self):
        ...
        file_name = f"get_bc_diskstats_{timestamp}.json"
